  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto space-y-16 relative z-10">
        {/* Section Header */}
        <div className="max-w-3xl space-y-3" data-anime="reveal">
        ...
        {/* 4 Counter Cards Grid — stagger-grid handles entrance */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6" data-anime="stagger-grid">
          {statsData.map((item) => (
            <div
              key={item.id}
              ...
              data-anime="border-glow"
            >
              {/* Icon */}
              <div className="flex items-center justify-between">
                <div className={`w-13 h-13 rounded-xl border flex items-center justify-center transition-all duration-300 group-hover:scale-110 ${item.iconStyle}`}>
              ...
              {/* Anime.js counter — picked up by AnimeScrollOrchestrator */}
